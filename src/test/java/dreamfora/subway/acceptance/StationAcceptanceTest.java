...
import static dreamfora.subway.acceptance.StationSteps.지하철역_삭제_요청;
...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    void getStations() {
        ...
        // when
        ExtractableResponse<Response> stationResponse = RestAssured.given().log().all().when().get("/stations").then().log().all().extract();
