...
import static dreamfora.subway.acceptance.FavoriteSteps.즐겨찾기_목록_조회_요청;
import static dreamfora.subway.acceptance.FavoriteSteps.즐겨찾기_목록_조회됨;
import static dreamfora.subway.acceptance.FavoriteSteps.즐겨찾기_삭제_요청;
import static dreamfora.subway.acceptance.FavoriteSteps.즐겨찾기_삭제됨;
import static dreamfora.subway.acceptance.FavoriteSteps.즐겨찾기_생성됨;
import static dreamfora.subway.acceptance.FavoriteSteps.즐겨찾기_생성을_요청;
import static dreamfora.subway.acceptance.LineSteps.지하철_노선에_지하철_구간_생성_요청;
import static dreamfora.subway.acceptance.MemberSteps.로그인_되어_있음;
import static dreamfora.subway.acceptance.StationSteps.지하철역_생성_요청;
